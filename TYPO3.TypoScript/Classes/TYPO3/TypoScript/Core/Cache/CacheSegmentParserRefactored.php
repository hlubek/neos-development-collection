 ...
 */
class CacheSegmentParserRefactored
{
    /**
     * @var string
     */
...
,        ];
    ...
    {
        return Functions::substr($this->content, $fromPosition, ($toPosition === null ? $toPosition : $toPosition - $fromPosition));
    }
    ...
    {
        return Functions::strpos($this->content, $token . $this->randomCacheMarker, $currentPosition);
    }
